...
window.COLUMN_NOTES = {
  ...
  WSHOBL: {
    title: "Assets: Securities Held Outright: U.S. Treasury Securities: Bills: Wednesday Level",
    source: "Board of Governors of the Federal Reserve System (US)",
    units: "Millions of dollars, weekly NSA, Wednesday",
    url: "https://fred.stlouisfed.org/series/WSHOBL",
    official: "H.4.1. SOMA Treasury bills only. They mature; they are not duration.",
    why: "Fed bill RMPs / TGA plumbing. Rising bills at the Fed is not the House failing on the long end.",
  },
  WSHONBNL: {
    title: "Assets: Securities Held Outright: U.S. Treasury Securities: Notes and Bonds, Nominal: Wednesday Level",
    source: "Board of Governors of the Federal Reserve System (US)",
    units: "Millions of dollars, weekly NSA, Wednesday",
    url: "https://fred.stlouisfed.org/series/WSHONBNL",
    official: "H.4.1. SOMA nominal notes and bonds. Duration on the central bank.",
    why: "The delusion print. If this turns up after House ops, leftover did not clear the longs.",
  },
  WSHONBIIL: {
    title: "Assets: Securities Held Outright: U.S. Treasury Securities: Notes and Bonds, Inflation-Indexed: Wednesday Level",
    source: "Board of Governors of the Federal Reserve System (US)",
    units: "Millions of dollars, weekly NSA, Wednesday",
    url: "https://fred.stlouisfed.org/series/WSHONBIIL",
    official: "H.4.1. SOMA TIPS. Counted with nominal notes/bonds as Fed duration.",
    why: "TIPS are duration too. Folded into the coupon line on the canny/deluded tracker.",
  },
  RRPONTSYD: {
